...
contract ArenaGround {
    ...
    This is a Giveaway Contract that aims to gift out funds to users by setting or joining arena and being alone inside the arena still the arena Lock time period expires
    Major functions:
